...
<ul class="nav nav-tabs">
	...
	<li role = "presentation" ><a href="reviewBoard_Cat.jsp?pageNum=1&url=cat">고양이</a></li>
	<li role = "presentation" class ="active" ><a href="reviewBoard_Others.jsp?pageNum=1&url=others">그 외</a></li>
	<!-- 글쓰기 버튼 -->
	<li id="WriteButton"><a class="btn btn-primary btn-sm role ="button" onclick="location.href='review_write.jsp?url=others'">글쓰기</a></li>
	<!-- 글쓰기 버튼 끝 -->
</ul>
<!-- 게시판 탭 끝 -->
...
<div class="row">
	<div class="col-lg-6">
	<form method="GET" action="reviewBoard_Others.jsp?pageNum=1&url=dog" >
...
<nav>
  <ul class="pagination">
    ...
    <li><a class="active" href="reviewBoard_Dog.jsp?pageNum=<%=i%>&url=others"> <%=i %><span class="sr-only"></span></a></li>
    <%
    	}
    %>
