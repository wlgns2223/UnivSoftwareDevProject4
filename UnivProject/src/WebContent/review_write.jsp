...
<!-- 글쓰기 페이지 시작 -->
<div class="container">
	<form method="post" action="reviewWriteAction.jsp?url=<%=request.getParameter("url")%>">
		<label class="col-sm-2 control-label">Title</label>
		    ...
		    <label  class="col-sm-2 control-label">Content</label>
			    <div class="col-sm-10">
			      <textarea  class="form-control" placeholder="content" name="content" rows="7" maxlength = 2048 ></textarea>
			    </div>
